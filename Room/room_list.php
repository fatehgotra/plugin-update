...
<div class="flex flex-wrap min600">
   <div class="w-full mb-12 xl:mb-0 px-4 padding-top80">
      <div class="grid grid-cols-2 gap-4">
         ...
         <div class="mt-4">
            <h1 class="text-2xl text-black font-bold mb-3">All Rooms</h1>
         </div>
         <div class="mt-4">
         <a type="submit" class="addbtn btn btn-success" href="admin.php?page=add_room">Add Room</a>
         </div>
            ...
            <table class="table bg-white border border-slate-300 mt-4">
               ...
               <tbody>
                  <tr>
                     ...
                     <td class="border border-slate-300 text-center">
                    <a class="focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm p-2.5 text-center inline-flex items-center mr-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800 btn-warning" href="admin.php?page=edit_room&&id=1"><i class="fa fa-pencil" style="font-size:24px"></i></a>
